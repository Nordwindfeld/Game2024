...
public class Unit : MonoBehaviour
{
    ...
    public Skill1AttackType skill1AttackType;
    public Skill2AttackType skill2AttackType;
    public Skill3AttackType skill3AttackType;
    ...
    public int attackTPCost;
    public int skillAttack1TpCost;
    public int skillAttack2TpCost;
    public int skillAttack3TpCost;
