...
public class SwordRythmScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetButtonDown("Enter") && CorrectTiming == 1)
        {
            ...
            PlayerScript.GetComponent<Skills>().currentSwordRythmPrefab.GetComponent<Animator>().speed = 1f * CorrectMultiplier;
        }
